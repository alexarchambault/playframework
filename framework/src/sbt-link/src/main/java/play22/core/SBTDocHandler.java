...
public interface SBTDocHandler {
   ...
   *
   * @param request A request of type {@link play22.api.mvc.RequestHeader}.
   * @return A value of type {@link Option< play22.api.mvc.SimpleResult>}, Some if the result was
